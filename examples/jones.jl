...
# FIXME: add native equality constraint
cons = [cons; -1 .* cons]

pop = PolyOpt(objective, cons)

solver_config = SolverConfig(optimizer=Mosek.Optimizer, mom_order=3, ts_algo=MMD())

result.corr_sparsity.cliques[end]
